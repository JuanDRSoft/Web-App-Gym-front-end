...
import PreciosEntrenadoresResponsive from "../components/PreciosEntrenadoresResponsive";
  ...
  return (
    <div>
      ...
      <div className="invisible md:visible">
        ...
        <div className="md:flex justify-center text-center md:px-40 2xl:px-80 md:mb-20">
